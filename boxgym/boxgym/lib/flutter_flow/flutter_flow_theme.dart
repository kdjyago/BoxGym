...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color dorado = const Color(0xFFCB911C);
  late Color plateado = const Color(0xFF9AABB6);
  late Color diamante = const Color(0xFF5AADDA);
  late Color amarillo = const Color(0xFFFFBA00);
  late Color rojo = const Color(0xFFFF2332);
  late Color morado = const Color(0xFF4B39EF);
}
