    ...
    _model.textFieldFocusNode!.addListener(
      () async {
        if (_model.textController.text != '') {
          _model.escibiendo = true;
          setState(() {});
          return;
        } else {
          _model.escibiendo = false;
          setState(() {});
          return;
        }
      },
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRecord> usuariosUserRecordList = snapshot.data!;
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    '0ng5b9y4' /* Introduzca el nombre del usuar... */,
                                  ),
                            ...
                            builder: (context, snapshot) {
                              ...
                              return SingleChildScrollView(
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children:
                                      List.generate(columnUserRecordList.length,
                                          (columnIndex) {
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                'Nombre: ${columnUserRecord.displayName}',
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                'Teléfono: ${columnUserRecord.phoneNumber}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
